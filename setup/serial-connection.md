...
2. Load the <a href="./serial_usb_terminal_cfg.txt?raw=1" download target="_blank">Configuration File</a> by clicking on the config button in the upper right corner (the button showing three dots - also known as the kabob menu) and then "configuration -> import"
